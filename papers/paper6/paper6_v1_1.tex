...
$\rho\leftrightarrow\bar\rho$, and the equality
$\Re\Zt_p=\Re Z_p$ holds for every finite~$N$ used in this paper, so
all numerical values reported here are reproducible via $Z_p$.
...
\noindent\small
\emph{Paper~6 v1.1 \textperiodcentered\ April~2026}\\
\emph{Notation and Conventions section added; Paper~5 bibliography
title corrected; abstract terminology clarified}\\
